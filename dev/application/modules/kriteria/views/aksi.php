                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-info">
                                ...
                                <form class="form-horizontal" method="post" action="edit" data-refresh="<?=($is_update == 1 ? "false" : "true")?>" data-url="<?= site_url("kriteria/api/ubah") ?>" id="myForm" enctype="multipart/form-data" accept-charset="utf-8">
                                    <div class="card-body">
