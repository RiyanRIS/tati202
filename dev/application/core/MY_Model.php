...
class MY_Model extends CI_Model{
	...
	public function insert($data,$batch=FALSE, $data_aktivitas = null){
		if($batch == TRUE){
			$this->db->trans_begin();
			...
			$this->db->trans_begin();
				...
				// return $id;
				if($data_aktivitas != null ){
					$this->db->set($data_aktivitas);
					$this->db->set(['name_tabel'=>$this->_table_name]);
	...
	public function update($data,$where=array(), $data_aktivitas=null){
		$this->db->trans_begin();
			$this->db->set($data);
			$this->db->where($where);
